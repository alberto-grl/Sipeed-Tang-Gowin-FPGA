...
- Generating script should expose desired signals. Use
   ...
   - generate gateware with support for wishbone and csr.csv . This file contains the addressess for the various peripherals,
    ...
    ./sipeed_tang_primer_20k-1.py --soc-csv=soc.csf --with-etherbone --cpu-type=vexriscv --cpu-variant=lite --l2-size=512 --with-spi-sdcard --eth-ip 192.168.11.50 --build --csr-csv build/sipeed_tang_primer_20k/csr.csv
...
- start wishbone server
  activate virtual environment source ~/litex_venv/bin/activate
